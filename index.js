...
const studentFeeDemandRouter = require("./routes/studentfeedemand.router");
...
// ── Fee routers ───────────────────────────────────────────────
app.use("/raiseFeeDemand",   raiseFeeDemandRouter);
app.use("/feeCollection",    feeCollectionRouter);
app.use("/studentFeeDemand", studentFeeDemandRouter);

// ✅ Route bindings
app.use("/tchsc", tchscRouter);

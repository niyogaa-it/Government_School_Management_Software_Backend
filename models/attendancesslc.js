...
const AttendanceSSLC = sequelize.define("AttendanceSSLC", {
  id: {
...
AttendanceSSLC.belongsTo(School,  { foreignKey: "school_id" });
AttendanceSSLC.belongsTo(Grade,   { foreignKey: "grade_id" });
AttendanceSSLC.belongsTo(Section, { foreignKey: "section_id", as: "Section" });

module.exports = AttendanceSSLC;